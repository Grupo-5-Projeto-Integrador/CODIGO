...
import { Building2, Lock, Mail, ShieldAlert, Loader2 } from "lucide-react";
import { login } from "../../apiClient";

export function Login() {
  const navigate = useNavigate();
  const [email, setEmail] = useState("gerente@jpmall.com.br");
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Erro ao conectar com o servidor. Verifique se o backend está rodando em localhost:8080."
      );
    } finally {
      setLoading(false);
    }
